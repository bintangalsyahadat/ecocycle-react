        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          <div className="border-2 border-teal-600 rounded-2xl p-6 shadow-sm hover:shadow-md transition bg-white">
            <div className="flex flex-col items-center text-center">
              <div className="text-teal-600 text-7xl mb-4"><img src="/public/images/ecoducation/trash.png" alt="icon" className="w-25 h-25 object-contain" /></div>
          ...
          <div className="border-2 border-teal-600 rounded-2xl p-6 shadow-sm hover:shadow-md transition bg-white">
            <div className="flex flex-col items-center text-center">
              <div className="text-teal-600 text-7xl mb-4"><img src="/public/images/ecoducation/quiz.png" alt="icon" className="w-22 h-22 object-contain" /></div>
