            ...
            <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl p-6 relative">
                ...
                <div className="mt-6 bg-[#F7F7EE] p-4 rounded-xl">
                    ...
                    <div className="flex justify-between items-center mt-4 text-gray-700 text-sm">
                        ...
                        <div className="flex flex-col items-center">
                            <FaRecycle size={24} className="text-teal-600" />
                        ...
                        <div className="flex flex-col items-center">
                            <FaGift size={24} className="text-teal-600" />
                    ...
                    <button
                        ...
                        className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-lg mt-5"
                    >
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                    <button
                        ...
                        className="bg-teal-600 hover:bg-teal-700 text-white flex flex-col items-center rounded-lg py-3"
                    >
                        <FaWhatsapp size={28} />
                        <p className="text-sm mt-2">Bagikan di whatsapp</p>
                    </button>

                    <button className="bg-teal-600 hover:bg-teal-700 text-white flex flex-col items-center rounded-lg py-3"
                    >
                        <FaShareAlt size={28} />
